...
let passes = {"hcm": "Halil Can M", "jacob": "Jacob", "gaston": "Gaston", "omkar": "Omkar", "dani": "Dani"};
...
function publish(optionsObject) {
    ...
    if (!passes.hasOwnProperty(passCodeField.value)) {
    ...
    let obj = {
        ...
        "author": passes[passCodeField.value],
